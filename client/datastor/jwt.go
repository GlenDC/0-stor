...
func JWTTokenGetterUsingIYOClient(organization string, client IYOClient) *IYOBasedJWTTokenGetter {
...
// we use buckets as a strategy to help migate the cost of locking.
...
const (
	...
	jwtTokenCacheMinTTLInSeconds = 30
)
